            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  Example -  Deal 100 damage to 'pat' with the message 'A spike impales you!': <code>/damage pat 100 A spike impales you!</code>
                  Example -  Deal 100 damage to action initiator: <code>/damage <span v-pre>{{</span> actor <span v-pre>}}</span> 100</code>
                  Example -  Deal 100 damage to all mobs in the room: <code>/damage all.mob 100</code>
                  Example -  Deal 100 damage to all players in the room: <code>/damage all.player 100</code>
