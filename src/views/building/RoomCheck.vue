            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <br />mob is absent - whether a mob with template id 'argument' in the room is not present. If 'argument2' is specified as a faction, only that faction will be affected by the check.
